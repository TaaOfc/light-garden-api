...
const game = [
    {name: 'Tebak Kata', category: 'Game', requestMethod: 'GET' ,description: 'Game Tebak Kata', queryParameter: 'apikey', status: 'active', link: '/api/game/tebakkata?q=https://raw.githubusercontent.com/AlipBot/data-rest-api/main/tebakkata.json&apikey=okta'},
]
