...
const internet =  [
    ...
    { name: 'Bard', category: 'Internet', requestMethod: 'GET', description: 'Kecerdasan Buatan', queryParameter: 'apikey, q', status: 'active', link: '/api/internet/bardAi?q=hai&apikey=okta'},
